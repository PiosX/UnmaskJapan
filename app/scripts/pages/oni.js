...
export default class Oni extends Animation {
  constructor() {
    super();
    this.counter = 1;
    this.oni = document.querySelector('.oni');
    this.homeMask = document.querySelector('.home__mask');
    this.item1 = document.querySelector('.oni-item-1');
    this.item2 = document.querySelector('.oni-item-2');
    this.item3 = document.querySelector('.oni-item-3');
    this.item4 = document.querySelector('.oni-item-4');
    this.item5 = document.querySelector('.oni-item-5');
    this.item6 = document.querySelector('.oni-item-6');
    this.button = document.querySelector('.component__button');
    this.jpOni = document.querySelector('.oni__content__title');
    this.enOni = document.querySelector('.oni__title-en');
    this.animations();
    this.addEvents();
    this.redirect();
  }
  ...
  animations() {
    this.jpTitleAnimation(this.jpOni);
    this.enTitleAnimation(this.enOni);
  }
      ...
      setTimeout(() => {
        this.homeMask.addEventListener('click', () => {
          ...
          if (this.counter === 5 && this.item4.style.opacity === '0') {
            ...
            this.item6.style.top = '50%';
            this.item6.style.opacity = 1;
          ...
          if (this.counter === 6 && this.item5.style.opacity === '0') {
            this.homeMask.style.display = 'none';

            this.item6.style.top = '-150%';
            this.item6.style.opacity = 0;
